...
/* Function for return view for creative view profile page for not login user */
    ...
    {$clientData = [];
        ...
        return view('web.creative_profile_view', compact('userData', 'status', 'clientData', 'genres', 'genders', 'types', 'crafts', 'platforms'));
    }
...
/****************Update Creative profile data******/
    ...
    public function saveProject(Request $request)
    {
        ...
        if ($request->file('projectImage') != null) {
            ...
            // Storage::putFileAs('public/storage/uploads', $file, $projectImage);
        }
    ...
    public function addConnection(Request $request, $id)
    {
        ...
        if($connectionId){
			...
			if($updateFlag == ""){
				 $updateFlag = \DB::table('project_edit_requests')->where([['project_id', '=', $connectionId->project_id],['user_id', '=', $connectionId->contributor_id],['contributor_id', '=', $connectionId->user_id]])->update($values);
			}
        }
