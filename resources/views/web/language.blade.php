                                       ...
                                       <fieldset class="form-group radios">
                                          ...
                                          <div class="languages pt-1">
                                             <div class="form-check d-inline-flex rdio pr-5">
                                                ...
                                                <div class="radiobuttons">
                                                   <div class="rdio rdio-primary radio-inline">
                                                      <input name="radio" value="1" id="radio1" type="radio" <?php if (!empty($user['language']) && $user['language'] === '1') {echo 'checked="checked"';} ?>>
                                             ...
                                             <div class="form-check d-inline-flex rdio pr-5">
                                                ...
                                                <div class="radiobuttons">
                                                   <div class="rdio rdio-primary radio-inline">
                                                      <input name="radio" value="en" id="radio2" type="radio" <?php if (!empty($user['language']) && $user['language'] === 'en') {echo 'checked="checked"';} ?>>
                                             ...
                                             <div class="form-check d-inline-flex rdio pr-5">
                                                ...
                                                <div class="radiobuttons">
                                                   <div class="rdio rdio-primary radio-inline">
                                                      <input name="radio" value="es" id="radio3" type="radio" <?php if (!empty($user['language']) && $user['language'] === 'es') {echo 'checked="checked"';} ?>>
                                             ...
                                             <div class="form-check d-inline-flex rdio pr-5">
                                                ...
                                                <div class="radiobuttons">
                                                   <div class="rdio rdio-primary radio-inline">
                                                      <input name="radio" value="fr" id="radio4" type="radio" <?php if (!empty($user['language']) && $user['language'] === 'fr') {echo 'checked="checked"';} ?>>
                                             ...
                                             <div class="form-check d-inline-flex rdio pr-5">
                                                ...
                                                <div class="radiobuttons">
                                                   <div class="rdio rdio-primary radio-inline">
                                                      <input name="radio" value="zh" id="radio5" type="radio" <?php if (!empty($user['language']) && $user['language'] === 'zh') {echo 'checked="checked"';} ?>>
