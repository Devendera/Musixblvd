			...
			<section class="left-side mt-5 col-md-4 pd-right">
												...
												<div class="justify-content-center">
													<div class="d-flex justify-content-center ">
														<div>
															...
															<div class="font-14-weight500 mt-2">
																<label class="file-upload" for="fileUpload">{{ __('msg.clickhere')}} to </label> <span class="font-12-res"> {{ __('msg.touploadimage')}}</span>
							...
							<div class="row form-home home form-login form-register">
								...
								<div class="form-group col-md-12">
									...
									<select name="privacy" id="privacy" class="form-control">
										...
										<option value="private">{{ __('msg.public')}}</option>
									</select>
								</div>
							</div>
						</div>
				...
				<div class="bg-white left-sidebar rounded-xl shadow-sm mt-2 pb-3">
												...
												<div class="d-flex justify-content-start">
                                                   ...
                                                   <span><img
                                                      src="assets/images/sound-upload.svg"></span>
															<label class="file-upload main-text-color ml-2" for="fileUpload1">{{ __('msg.clickhere')}} to</label> <span class="ml-1 margin-top2">{{ __('msg.uploadaudio')}}</span>
															<input class="custom-file-input" accept="mp3,mp4,ogg,mpeg,wav" name="projectAudio" type="file" id="fileUpload1"> </div>
													</div>
												</div>
											</div>
										</div>
					...
					<div class="mt-4 pt-1 pb-2">
						<div class="col-md-12 card border-0 rounded-md">
							<div class="d-flex justify-content-between"> <span class="audio-file" id="filename"> {{ __('msg.audiofilenamehere')}}</span> </div>
						</div>
					</div>
				</div>
			</section>
