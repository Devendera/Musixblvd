							...
							<div class="row">
								<div class="col-md-8">
									...
									<?php if(Auth::guard('web')->check()){ ?>
													<button type="button" class="btn btn-sm btn-primary btn-edit mt-3 ml-r0 add-connection-btn" data-id="{{$userData->user_id}}" data-url="{{URL::to('/')}}" data-type="{{$userData->type}}">{{$status}}</button>
													<button type="button" class="add-request-btn req-mgmt ml-r0 req-mgmt-pending"  data-id="{{$userData->user_id}}" data-url="{{URL::to('/')}}" data-type="{{$userData->type}}">{{$request}}</button>
												<?php } else { ?>
													<button type="button" class="btn btn-sm btn-primary btn-edit mt-3 ml-r0 " >Message</button>
													<button type="button" class="req-mgmt ml-r0 req-mgmt-pending "  >Request Management</button>
												<?php } ?>
												</div>
											</div>
										</div>
								...
								<div class="col-md-4">
									<div class="float-right right-pro">
										<div class="total-connections">
											...
											<span class="projects">{{ __('msg.connections')}}</span
