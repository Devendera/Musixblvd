            ...
            <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="content-cell">
                        ...
                        <p>We received a request to change your email address. Please verify your new email first.</p>
                        <!-- Action -->
                            ...
                            <tr>
                                <td align="center">
                                    <div>
                                        ...
                                        <a href="{{ url('user/verify-new-email', $data['verification_code']) }}" class="button button--blue">Verify Email</a>
                                    </div>
                                </td>
                            </tr>
                        </table>
